...
public class UserProcess {
	...
	public UserProcess() {
		...
		descriptorManager[0] = ThreadedKernel.console.openForReading();
		descriptorManager[1] = ThreadedKernel.console.openForWriting();
		...
		public int close(int fileDescriptor) {
			...
			if (files.get(fileName) > 1)
				...
				if (removed.contains(fileName)) {
					...
					UserKernenel.fileSystem.remove(fileName);
				}
			}
			return 0;
		}
...
*/
	...
	protected static final int maxFileDesriptor = 16;
	protected static Hashtable<String, Integer> files = new Hastable<string, Integer>();
	protected static HasSet<String> removed = new HashSet<string>();
	protected static hastable<Integer, UserProcess> currentProcess = new Hashtable<Integer, UserProcess>();
	protected static Hastable<Integer, UserProcess> deadProcess = new Hastable<Integer, UserProcess>
